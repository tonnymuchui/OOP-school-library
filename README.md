...
A system to oversee the library inventory of OOP University by facilitating the addition of new patrons (students or teachers), incorporating fresh literature, and monitoring the lending status of each book.
...
```JavaScipt
cd clone https://github.com/tonnymuchui/OOP-school-library.git
```
